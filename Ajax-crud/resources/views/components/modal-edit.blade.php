    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="name" class="control-label">Cek</label>
                    <input type="text" class="form-control" id="cek-edit">
                    <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-cek-edit"></div>
                </div>
    ...
    $('body').on('click', '#btn-edit-post', function () {
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                $('#cek-edit').val(response.data.cek);
        ...
        $.ajax({
            ...
            error:function(error){
                ...
                if(error.responseJSON.content[0]) {
                    ...
                    //show alert
                    $('#alert-cek-edit').removeClass('d-none');
                    $('#alert-cek-edit').addClass('d-block');

                    //add message to alert
                    $('#alert-cek-edit').html(error.responseJSON.cek[0]);
                } 
